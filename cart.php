...
<html lang="en">
    ...
    <body>
        ...
        ?>
        <div id="banner_image" style="height: 900px;margin-bottom: 0px;">
            <div class="container">
                        ...
                        <table class="table table-responsive table-hover table-condensed" style="background-color: rgba(255, 255, 255, 0.7);font-size:20px;color:#000000;margin-top:100px">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    $sum+= $row["Price"];
                                    echo "<tr><td>" .$row["Name"] . "</td><td>Rs " .$row["Price"] . "</td><td><a href='includes/cart-remove.php?id={$row['id']}' class='remove_item_link'> Remove</a></td></tr>";
                                }
